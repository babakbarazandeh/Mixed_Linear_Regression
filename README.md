...
Fig.~\ref{fig:table} shows the result of the experiment. This figure consists of two tables. Numbers in the tables are the average of the recovery error and numbers in parentheses are the standard deviation of 30 runs for each pair (K,d). In these tables, blue numbers represent the performance of the proposed method and numbers below it show the performance of the EM method for the same pair (K,d). 
